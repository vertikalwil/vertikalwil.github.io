...
I will show step by step on how to do the projects so this will be very technical, but If you only want to see the big picture, I am also preparing the link for the presentation.
...
::: {style="font-size: 90%;"}
{{< embed ../../ipynb/final-project.ipynb#infokolom >}}
:::

Columns from 9 to 14 are actually benefits that customers can choose to take.
...
::: {style="font-size: 90%;"}
{{< embed ../../ipynb/final-project.ipynb#tabel >}}
:::

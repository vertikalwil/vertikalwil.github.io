...
On this particular blog post, I will show detailed step by step on how to do the projects (including the codes) so this will be very technical, but if you just want to see the big picture you can visit these link:

Presentation link : [Click here](https://docs.google.com/presentation/d/e/2PACX-1vR0dOy0icSQtH47y4pXOvki-xwIL4wtljaLZkL_NXMp5fN2sBzJlLuYRaGY5SWqew/pub?start=true&loop=false&delayms=60000) <Br>
App deployment link : [Shinyapps.io](https://vertikalwil.shinyapps.io/telco_deploy/)
...
<div class="popup">
<p>Hey, in case you missed it, I've also provided links to the PPT presentation and to shinyapps.io platform for the app deployment. You can find these links at the top of the page. Thanks!</p>
<a class="special-button" id="closed">I understand!</a>
</div>
</div>

...
author: "Vertikal"
date: "2023-08-30"
description: How it is important to determine the cost of missclassification error before starting binary classification project especially with imbalanced dataset. 
...
Let's calculate the miss classification costs on all threshold : <Br>
